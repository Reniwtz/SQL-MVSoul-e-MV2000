...
--               PED_RX . DT_PEDIDO,
         ...
         WHERE EMPRESA_CONVENIO . CD_CONVENIO = CONVENIO . CD_CONVENIO
           ...
           AND TRUNC(PED_RX . DT_PEDIDO) BETWEEN '01/06/2022' AND '30/06/2022'
...
--               PED_RX . DT_PEDIDO,
         ...
         WHERE EMPRESA_CONVENIO . CD_CONVENIO = CONVENIO . CD_CONVENIO
           ...
           AND PED_RX . CD_CONVENIO = CONVENIO . CD_CONVENIO
           AND TRUNC(PED_RX . DT_PEDIDO) BETWEEN '01/06/2022' AND '30/06/2022'
           AND (NVL(ITPED_RX . SN_REALIZADO, 'N') = 'N' OR TRUNC(ITPED_RX . DT_REALIZADO) > '31/05/2022')
           AND PED_RX.CD_SET_EXA = 13
--           AND PED_RX.CD_CONVENIO in (1,2,16)
         GROUP BY PED_RX   . CD_CONVENIO,
                  CONVENIO . NM_CONVENIO,
...
--               PED_RX . DT_PEDIDO,
         ...
         WHERE EMPRESA_CONVENIO . CD_CONVENIO = CONVENIO . CD_CONVENIO
           ...
           AND PED_RX . CD_CONVENIO = CONVENIO . CD_CONVENIO
           AND TRUNC(PED_RX . DT_PEDIDO) BETWEEN '01/06/2022' AND '30/06/2022'
           AND TRUNC(ITPED_RX . DT_REALIZADO) BETWEEN '01/06/2022' AND '30/06/2022'
...
--               PED_RX . DT_PEDIDO,
         ...
         WHERE EMPRESA_CONVENIO . CD_CONVENIO = CONVENIO . CD_CONVENIO
           ...
           AND ITPED_RX . CD_PED_RX = PED_RX . CD_PED_RX
           AND PED_RX . CD_CONVENIO = CONVENIO . CD_CONVENIO
           AND TRUNC(PED_RX . DT_PEDIDO) < '01/07/2022'
           AND TRUNC(ITPED_RX . DT_REALIZADO) BETWEEN '01/06/2022' AND '30/06/2022'
           AND PED_RX.CD_SET_EXA = 13
--           AND PED_RX.CD_CONVENIO in (1,2,16)
         GROUP BY PED_RX   . CD_CONVENIO,
