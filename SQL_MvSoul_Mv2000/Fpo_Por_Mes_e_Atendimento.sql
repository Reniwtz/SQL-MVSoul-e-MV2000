...
-- BPA
SELECT
    a.cd_procedimento  AS procedimento,
    ps.ds_procedimento AS descricao,
...
FROM
         atendime a
    INNER JOIN procedimento_sus ps ON a.cd_procedimento = ps.cd_procedimento
WHERE
    a.cd_procedimento IN ( '0201010020', '0201010046', '0201010194', '0201010232', '0201010275',
        ...
        -- seu IN com todos os códigos aqui
