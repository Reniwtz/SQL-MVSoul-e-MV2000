  ...
  FROM (
        SELECT PED_RX . CD_CONVENIO,
         ...
         WHERE EMPRESA_CONVENIO . CD_CONVENIO = CONVENIO . CD_CONVENIO
           ...
           AND ITPED_RX . CD_PED_RX = PED_RX . CD_PED_RX
           AND PED_RX . CD_CONVENIO = CONVENIO . CD_CONVENIO
           AND PED_RX . DT_PEDIDO >= TO_DATE('01/04/2026', 'DD/MM/YYYY')
           AND PED_RX . DT_PEDIDO <  TO_DATE('30/04/2026', 'DD/MM/YYYY') + 1
           AND PED_RX . CD_SET_EXA = 13
--           AND PED_RX . CD_CONVENIO IN (1,2,16)
         GROUP BY PED_RX . CD_CONVENIO,
                  CONVENIO . NM_CONVENIO,
        ...
        SELECT PED_RX . CD_CONVENIO,
         ...
         WHERE EMPRESA_CONVENIO . CD_CONVENIO = CONVENIO . CD_CONVENIO
           ...
           AND PED_RX . DT_PEDIDO <  TO_DATE('30/04/2026', 'DD/MM/YYYY') + 1
           AND (
                NVL(ITPED_RX . SN_REALIZADO, 'N') = 'N'
                OR ITPED_RX . DT_REALIZADO >= TO_DATE('30/04/2026', 'DD/MM/YYYY') + 1
               )
           AND PED_RX . CD_SET_EXA = 13
--           AND PED_RX . CD_CONVENIO IN (1,2,16)
         GROUP BY PED_RX . CD_CONVENIO,
        ...
        SELECT PED_RX . CD_CONVENIO,
         ...
         WHERE EMPRESA_CONVENIO . CD_CONVENIO = CONVENIO . CD_CONVENIO
           ...
           AND PED_RX . DT_PEDIDO >= TO_DATE('01/04/2026', 'DD/MM/YYYY')
           AND PED_RX . DT_PEDIDO <  TO_DATE('30/04/2026', 'DD/MM/YYYY') + 1
           AND ITPED_RX . DT_REALIZADO >= TO_DATE('01/04/2026', 'DD/MM/YYYY')
           AND ITPED_RX . DT_REALIZADO <  TO_DATE('30/04/2026', 'DD/MM/YYYY') + 1
           AND NVL(ITPED_RX . SN_REALIZADO, 'N') = 'S'
           AND PED_RX . CD_SET_EXA = 13
--           AND PED_RX . CD_CONVENIO IN (1,2,16)
         GROUP BY PED_RX . CD_CONVENIO,
        ...
        SELECT PED_RX . CD_CONVENIO,
         ...
         WHERE EMPRESA_CONVENIO . CD_CONVENIO = CONVENIO . CD_CONVENIO
           ...
           AND ITPED_RX . CD_PED_RX = PED_RX . CD_PED_RX
           AND PED_RX . CD_CONVENIO = CONVENIO . CD_CONVENIO
           AND PED_RX . DT_PEDIDO < TO_DATE('01/05/2026', 'DD/MM/YYYY')
           AND ITPED_RX . DT_REALIZADO >= TO_DATE('01/04/2026', 'DD/MM/YYYY')
           AND ITPED_RX . DT_REALIZADO <  TO_DATE('30/04/2026', 'DD/MM/YYYY') + 1
           AND PED_RX . CD_SET_EXA = 13
--           AND PED_RX . CD_CONVENIO IN (1,2,16)
